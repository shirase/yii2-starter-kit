...
return [
    ...
    'Saved' => 'Сохранено',
    'This email has already been taken.' => 'Это письмо уже отправлено',
    'Your account has been successfully activated.' => 'Аккаунт успешно активирован',
    'Your account has been successfully created. Check your email for further instructions.' => 'Ваш аккаунт успешно создан. Слейдуйте инструкциям на Email',
    'Your activation link: {url}' => 'Ссылка для активации: {url}',
    'Главная' => '',
    'Добавить' => '',
    'Добавить блок' => '',
    'Изменить' => '',
