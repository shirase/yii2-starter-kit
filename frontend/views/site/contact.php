...
<div class="site_contact">
    ...
    <div class="row">
        <div class="col-lg-5">
            <?php Pjax::begin(['id' => 'contact_form_holder', 'enablePushState' => false, 'linkSelector' => false, 'formSelector' => false]) ?>
            <?php Pjax::begin(['id' => 'contact_form_container', 'enablePushState' => false]) ?>
            <?php $form = ActiveForm::begin(['id' => 'contact-form', 'enableClientValidation' => false, 'options' => ['data-pjax' => true]]); ?>
